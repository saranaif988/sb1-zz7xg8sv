  ...
  const coreValues = [
    {
      ...
      title: "Quality First",
      description:
        "We never compromise on the quality of our products, ensuring the best results for every project.",
    },
    {
      icon: Leaf,
      title: "Eco-Friendly",
      description:
        "Our commitment to environmental responsibility drives us to develop sustainable paint solutions.",
    },
    {
      icon: HeartHandshake,
      title: "Customer Focus",
      description:
        "We put our customers at the heart of everything we do, providing exceptional service and support.",
    },
    {
      icon: Lightbulb,
      title: "Innovation",
      description:
        "Continuous research and development to bring you the latest in paint technology.",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url(https://ueaiiwmblxyqsflvnzir.supabase.co/storage/v1/object/public/image//decor2.jpg)",
        }}
      >
        <div className="absolute inset-0 bg-black bg-opacity-50" />
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="max-w-2xl text-white">
            <h1 className="md:text-3xl text-2xl font-bold text-white tracking-wide mb-4">
              {t("about.title")}
            </h1>
            <p className="text-light   text-white opacity-90">
              {t("about.subtitle")}
            </p>
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl font-bold tracking-wide text-[#233054] mb-6">
              {t("about.story.title")}
            </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12">
            <div className="bg-white p-8  shadow-lg">
              <h3 className="text-3xl font-bold text-[#233054] tracking-wide mb-4">
            ...
            <div className="bg-white p-8  shadow-lg">
              <h3 className="text-2xl font-bold text-[#233054] tracking-wide mb-4">
